...
@RestController
@RequestMapping("/tbSkillTrainController")
public class TbSkillTrainController {

    @Autowired
    private TbSkillTrainService tbSkillTrainService;
    ...
    public String querySkillTrain(HttpServletRequest request, HttpServletResponse response, String page, String limit) {
        ...
        ResultData resultData = tbSkillTrainService.querySkillTrain(Integer.parseInt(page), Integer.parseInt(limit));
