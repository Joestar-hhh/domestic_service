...
<form class="layui-form" action="javascript:void(0);">
    ...
    <div class="layui-form-item">
        <input type="text" placeholder="昵   称" hover class="layui-input" id="name" name="name"
               lay-verify="required"/>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <input type="text" placeholder="年  龄" hover class="layui-input" id="age" name="age"
               lay-verify="required"/>
    </div>
...
<%--    ---------------------%>
    <div class="layui-form-item">
        <a href="<%=path%>/pages/user/user_login.jsp">登录</a>
    </div>

    <div class="layui-input-item">
        <button type="submit" class="layui-btn pear-btn-primary login" lay-submit="" lay-filter="formDemo">立即注册</button>
    </div>
...
<script>
    ...
    layui.use(['form', 'element', 'jquery'], function () {
        ...
        from.on('submit(formDemo)', function (data) {
            ...
            $.ajax({
                url: '<%=path%>/userController/insertUser',
                type: 'POST',
                dataType: 'JSON',
                data: data.field,
                success: function (msg) {
                    if(msg.code=='0'){
                        layer.alert(msg.msg,function () {
                            location.href="<%=path%>/pages/user/user_login.jsp"
                        })
                    }else{
                        layer.msg(msg.msg);
                    }
