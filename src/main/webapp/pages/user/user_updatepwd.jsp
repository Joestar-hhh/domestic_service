...
<form class="layui-form" action="javascript:void(0);">
    ...
    <div class="layui-form-item">
        ...
        <input type="password" name="pwd" lay-verify="required" placeholder="请输入新密码" lay-verify="required"
    ...
    <div class="layui-form-item">
        <a href="<%=path%>/pages/user/user_login.jsp">登陆</a>
    </div>
...
<script>
    layui.use(['form', 'element', 'jquery'], function () {
        ...
        from.on('submit(formDemo)', function (data) {
            ...
            $.ajax({
                url: '<%=path%>/userController/phone_update_pwd',
                type: 'POST',
                dataType: 'JSON',
                data: data.field,
